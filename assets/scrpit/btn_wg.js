...
cc.Class({
    ...
    onLoad () {
        ...
        clickEventHandler.component = "btn_wg";//这个是脚本文件名
    ...
    btnClick1 (event, customEventData) {
       ...
       var btn_list = cc.find("Canvas/main/node/wugong")
       ...
       if(name){
           var right = cc.moveTo(0,-btn_list.getPosition().x,0);
           ...
           selectTab.setUserData('武功')
           btn_list.dispatchEvent(selectTab)
